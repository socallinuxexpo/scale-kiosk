  ...
  flake =
    { pkgs, ... }:
    {
      apps.x86_64-linux.binfmt-sdk-nixos-shell = {
        type = "app";
        program = builtins.toPath (
          inputs.nixpkgs.legacyPackages.x86_64-linux.writeShellScript "run-binfmt-sdk-nixos-shell" ''
            rm nixos.qcow2 || true
      ...
      nixosConfigurations.binfmt-sdk-nixos-shell =
